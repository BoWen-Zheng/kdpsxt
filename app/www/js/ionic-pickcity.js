  		...
  		function($rootScope, $ionicModal, $timeout, CityPickerService, $ionicScrollDelegate) {
	  		return {
	          	...
	          	template: '<div class="{{::vm.cssClass}}">'+
	          				...
	          				'<span class="item-note address{{::vm.id}}" ng-bind="vm.items">'+
							'</span>'+
	  					   	'</a>'+
	  					  '<div>',
	  			...
	  			link: function(scope, element, attrs) {
	  				var vm = scope.vm = {},
	  					...
	  					vm.iconPosition = so.iconPosition,
	  					vm.iconClass = so.iconClass,
        				...
        				vm.isCache = so.isCache === undefined ? true :(Boolean(so.isCache) ? true : false);
	  					...
	  					*/
						$ionicModal.fromTemplateUrl('js/template/ionic.citypicker.html', {
				            'scope': scope,
