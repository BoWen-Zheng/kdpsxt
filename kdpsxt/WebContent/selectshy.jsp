...
<script type="text/javascript">
	$(function(){
		...
		var shy=new Shy();
		shy.compageview("selectshy",1,'#table','#nav');
				...
				<div class="panel-body">
					<form action="">
							<div class="row">
								...
								<label class="col-xs-8 control-label">收货员名称</label>
								<div class="col-xs-8">
									<input type="text" class="form-control" id="xm" name="xm" placeholder="请输入产品名称">
								</div>
								</div>
								<div class="col-xs-4" >
