...
<div id="jbxxid" class="xxk" style="margin-top:30px">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-9">
      <input type="text" class="form-control"  name="spmc" placeholder="请输入产品名称">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-xs-9">
      <input type="text" class="form-control"  name="spxq" placeholder="请输入产品描述">
    </div>
  </div>
    ...
    <div class="col-xs-9">
      <input type="text" class="form-control"  name="spjg" placeholder="请输入产品价格">
    </div>
  </div>
