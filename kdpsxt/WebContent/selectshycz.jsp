  ...
  <div class="container-fluid">
	...
	<div class="row">
		...
		<div class="panel panel-default">
		  <div class="panel-heading"><h4>收货员修改</h4></div>
		  <div class="panel-body">
		  	<form action="updateshycz" class="form-group" method="POST" enctype="multipart/form-data">
		  	<input type="hidden" value="${param['id']}" name="id">
		  	<div class="form-group">
			    <label for="exampleInputPassword1">收货员名称</label>
			    <input type="text" class="form-control" id="xm" value="${requestScope.shy.xm}" name="xm">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">收货员电话</label>
			    <input type="text" class="form-control" id="dh" value="${requestScope.shy.dh}" name="dh">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">所在学校</label>
			    <input type="text" class="form-control" id="szxx" value="${requestScope.shy.szxx}" name="szxx">
			  </div>
			  <c:if test="${requestScope.shy.zt==0}">
			  <div class="form-group">
			    <label for="exampleInputPassword1">状态</label>
			    <input type="radio" id="zt" value="0" name="zt" checked="checked">工作
			    <input type="radio" id="zt" value="1" name="zt">休息
			  </div>
			  
			  </c:if>
			  <c:if test="${requestScope.shy.zt==1}">
			  <div class="form-group">
			    <label for="exampleInputPassword1">状态</label>
			    <input type="radio" id="zt" value="0" name="zt">工作
			    <input type="radio" id="zt" value="1" name="zt" checked="checked">休息
			  </div>
